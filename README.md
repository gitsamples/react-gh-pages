...
2. Add a `homepage` property in this format\*: `https://{username}.github.io/{repo-name}`
    ...
    ```diff
    {
      "name": "my-app",
      "version": "0.1.0",
    + "homepage": "https://gitsamples.github.io/react-gh-pages",
      "private": true,
    ```
...
At this point, the React app is accessible to anyone who visits the `homepage` URL you specified in Step 4. For example, the React app I deployed is accessible at https://gitsamples.github.io/react-gh-pages.
...
Note: I specified the avatars using HTML because, when I did so using Markdown,
      ...
      (e.g. 40px squared, for `https://github.com/gitsamples.png?size=40`);
...
<a href="https://github.com/gitname" target="_blank" title="gitname">
  <img src="https://github.com/gitsamples.png?size=40" height="40" width="40" alt="gitname" />
</a>
